...
try:
    ...
    joblib.dump(vectorizer, 'RR/векторизатор_преподавателей.pkl')
    print("Модель и векторизатор сохранены в файлы 'модель_преподавателей.pkl' и 'векторизатор_преподавателей.pkl'")
